...
the Phase I calibration set size $|\calIone|+|\calIcrc|$. Thus, for example,
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_coverage_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_size_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_coverage_diff_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_budget_used_boxplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_n_observed_events_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_mean_calibrated_a_weight_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_coverage_variance_barplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/toxicity_size_variance_barplot.jpg}
    \caption{\textbf{Toxicity LPBs}: observed unsafe events, mean weighted
    error $A_i(q_{\hat\tau})/\pi_i$, coverage variance, and LPB-value variance
    normalized so that Static equals one.  Results are computed over 50
    random splits.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_coverage_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_size_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_coverage_diff_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_budget_used_boxplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_n_observed_events_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_mean_calibrated_a_weight_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_coverage_variance_barplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_qwen_size_variance_barplot.jpg}
    \caption{\textbf{Red-Team LPBs with a Qwen judge}: observed unsafe events,
    mean weighted error $A_i(q_{\hat\tau})/\pi_i$, coverage variance, and LPB-value variance
    normalized so that Static equals one, over 50 random splits.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_coverage_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_size_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_coverage_diff_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_budget_used_boxplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_n_observed_events_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_mean_calibrated_a_weight_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_coverage_variance_barplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/red_team_llama_guard_size_variance_barplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_coverage_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_size_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_coverage_diff_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_budget_used_boxplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_n_observed_events_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_mean_calibrated_a_weight_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_coverage_variance_barplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/hallucination_size_variance_barplot.jpg}
    \caption{\textbf{Hallucination LPBs}: observed hallucination events, mean
    weighted error $A_i(q_{\hat\tau})/\pi_i$, coverage variance, and LPB-value variance
    normalized so that Static equals one, over 50 random splits.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_coverage_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_size_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_coverage_diff_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_budget_used_boxplot.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_n_observed_events_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_mean_calibrated_a_weight_boxplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_coverage_variance_barplot.jpg}\\
    \includegraphics[width=0.9\linewidth]{figures/full/lpb/autoif_size_variance_barplot.jpg}
    \caption{\textbf{AutoIF LPBs}: observed successful events, mean weighted
    error $A_i(q_{\hat\tau})/\pi_i$, coverage variance, and LPB-value variance
    normalized so that Static equals one, over 50 random splits.}
...
calibration samples in $\calIone$.  Each $3\times2$ figure reports the two
estimators and their empirical variances over repeated data partitions,
realized budget, and
the metric-target mean weighted error $A_i/\pi_i$.  The budget and
weighted-error panels exclude Uncalibrated and Oracle because these are not
comparable allocation quantities.  The red dashed estimator reference is the
exact value on the fully observed calibration--test population.
...
14.72 turns squared, while lowering the mean weighted error from 4.94 to
2.89.  The estimates remain centered near
the full-population references, whereas the naive unweighted event-rate
estimate is visibly biased downward.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/full/metric/dataset_toxicity/metric_estimation_3x2.jpg}
    \caption{Population-level event-rate and restricted-mean time-to-event
    estimation on \textbf{Toxicity}.  The configuration is $\bar B=20$,
    $N_1=50$, and $|\calIcrc|=50$, evaluated over 50 random splits.}
...
squared, while lowering the mean weighted error from 6.62 to 4.11.  The
no-CRC policy is slightly less
variable in this setting and uses essentially the full target budget.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/full/metric/dataset_red_team_qwen/metric_estimation_3x2.jpg}
    \caption{Population-level event-rate and restricted-mean time-to-event
    estimation on \textbf{Red-Team with a Qwen judge}.  The configuration is
    $\bar B=20$, $N_1=50$, and $|\calIcrc|=50$, evaluated over 50 random
    splits.}
...
squared and lowers the mean weighted error from 8.49 to 2.73.  CRC is conservative in
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/full/metric/dataset_red_team_llama_guard/metric_estimation_3x2.jpg}
    \caption{Population-level event-rate and restricted-mean time-to-event
    estimation on \textbf{Red-Team with Llama-Guard}.  The configuration is
    $\bar B=20$, $N_1=50$, and $|\calIcrc|=50$, evaluated over 50 random
    splits.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/full/metric/dataset_hallucination/metric_estimation_3x2.jpg}
    \caption{Population-level event-rate and restricted-mean time-to-event
    estimation on the \textbf{Hallucination} benchmark.  The configuration is
    $\bar B=20$, $N_1=50$, and $|\calIcrc|=50$, evaluated over 50 random
    splits.}
...
squared and lowers the mean weighted error from 4.73 to 2.71.  Thus, the
allocation principle is not
specific to unsafe-event detection.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/full/metric/dataset_autoif/metric_estimation_3x2.jpg}
    \caption{Population-level event-rate and restricted-mean time-to-event
    estimation on \textbf{AutoIF}.  The configuration is $\bar B=20$,
    $N_1=50$, and $|\calIcrc|=50$, evaluated over 50 random splits.}
...
study. The default cell has $\bar B=20$ and Phase I calibration set size
...
\subsubsection{Phase I calibration set size (LPB)}

Figure~\ref{fig:ablation_n1} varies the Phase I calibration set size over
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_n1_ablation.jpg}
    \caption{LPB Phase I calibration-set-size ablation. The x-axis is
    $|\calIone|+|\calIcrc|$, not $N_1$ alone.  Lines show means and shaded
    regions show one standard deviation over 50 random partitions.}
...
budget with the Phase I calibration set sizes
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_budget_ablation.jpg}
    \caption{LPB budget ablation.  Parenthesized x-axis values give the total
    Phase I calibration set size $|\calIone|+|\calIcrc|$.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_hard_soft_ablation.jpg}
...
50 Phase I calibration samples to CRC and uses no policy-fitting fold. It
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_metric_optimization_ablation.jpg}
...
increases.  The no-CRC curve is nonmonotone over finite partitions, although its
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_metric_score_noise_ablation.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_metric_score_ablation.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_metric_representation_ablation.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_metric_representation_diagnostics.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_cmax_ablation.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/ablations/dapro_attacker_shift_ablation.jpg}
    \caption{LPB attacker-shift ablation across the Red-Team and Toxicity
    datasets.  The x-axis identifies the dataset.  In both cases, the policy
    is calibrated on Qwen-attacker data and evaluated on Gemma-attacker data
    (Qwen $\rightarrow$ Gemma).  The target coverage is $90\%$ and
    $\bar B=10$.}
