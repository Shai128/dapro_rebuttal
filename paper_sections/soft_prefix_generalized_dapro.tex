...
\end{equation}
The production no-CRC method uses the raw zero-margin projection and therefore
sets
\begin{equation}
    \bar B_{\mathrm{shape}}:=\bar B_{\mathrm{II}}.
    \label{eq:spgd_no_crc_shape_budget}
\end{equation}
The scalar bisection in
...
Accordingly, this raw variant makes no finite-sample expected-budget claim;
the optional CRC controller below supplies that guarantee.
