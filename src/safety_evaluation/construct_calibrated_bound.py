...
def _safety_evaluation_source_fingerprint() -> str:
...
def run_experiments(cal_size, is_real, device, dataset_name, data_setup, experiments_name, seeds,
    ...
    source_fingerprint = _safety_evaluation_source_fingerprint()
    ...
    for seed in tqdm.tqdm(range(seeds[0], seeds[1]), desc="running calibration algorithms"):
        ...
        experiment_metadata = {
            ...
            "safety_evaluation_source_sha256": source_fingerprint,
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "method. The default preserves the existing N1=100 behavior."
        ),
    )
    parser.add_argument(
        '--fixed-data-seed',
