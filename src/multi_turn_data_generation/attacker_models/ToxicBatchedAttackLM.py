...
from src.multi_turn_data_generation.utils.system_prompts.toxic_system_prompts import roleplaying_prompt, \
    logical_appeal_prompt, authority_endorsement_prompt


class ToxicBatchedAttackLM(BatchedAttackLM):
    """
    ...
    @property
    def name(self) -> str:
        return f"toxic_attack_{self.model.model_name.name}_lm"
