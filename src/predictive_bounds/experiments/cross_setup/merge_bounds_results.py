"""Validate and merge sharded cross-setup predictive-bound results."""
...
from src.predictive_bounds.experiments.cross_setup.utils import get_cross_setup_experiment_name
    ...
    for seed in range(seeds[0], seeds[1]):
        ...
        if not manifest_path.exists():
            raise FileNotFoundError(
                ...
                "Rerun src.predictive_bounds.experiments.cross_setup."
