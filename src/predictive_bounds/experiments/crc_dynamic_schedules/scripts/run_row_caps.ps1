...
param(
    ...
    [string]$Suffix = $(if ($env:EXPERIMENT_SUFFIX) { $env:EXPERIMENT_SUFFIX } else { "crc_row_caps_v1" })
)

$ErrorActionPreference = "Stop"
$Methods = @(
    "calibration_dapro_variance_aligned_bins_2_alpha_0p10_global_0p001_budget_crc_control_100_row_cap_1p00x_budget_n1_200_allocation",
